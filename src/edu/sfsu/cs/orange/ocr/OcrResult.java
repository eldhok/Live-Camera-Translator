...
public class OcrResult {
  ...
  // this is the method to get bitmap
  
  private Bitmap getAnnotatedBitmap() {
 
	  
	  
		//new comment from here to avaoid getting green color 
    ...
    for (int i = 0; i < wordBoundingBoxes.size(); i++) {
     ...
     // paint.setColor(0xFF00CCFF);
      ...
      //new code
   //   if(OcrRecognizeAsyncTask.str[i]!=null && !OcrRecognizeAsyncTask.str[i].equals(""))
    //  canvas.drawText(OcrRecognizeAsyncTask.str[i], wordBoundingBoxes.get(i).left, wordBoundingBoxes.get(i).top ,p1); 
    }    
